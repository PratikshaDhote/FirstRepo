...
import com.clc.util.AppConstants;
...
public class ToolsQAPracticeForm extends RootPageObject{
	...
	public void selectGender(AppConstants.Genders p_gender){
	...
	public void selectAutomationTools(AppConstants.tools ...atools){
		for(AppConstants.tools tool : atools){
...
public void uploadPhoto(String fileUrl) throws InterruptedException, AWTException{
	...
	public void selectAutomationSkils(AppConstants.SkillSet ...skils){
		for(AppConstants.SkillSet skill : skils){
